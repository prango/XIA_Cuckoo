...
pkgdatadir = $(datadir)/cuckoo-hash
pkgincludedir = $(includedir)/cuckoo-hash
pkglibdir = $(libdir)/cuckoo-hash
pkglibexecdir = $(libexecdir)/cuckoo-hash
...
am__aclocal_m4_deps = $(top_srcdir)/m4/XProbes.m4 \
...
CONFIG_HEADER = $(top_builddir)/src/autoconfig.h
CONFIG_CLEAN_FILES = cuckoo-hash.spec stamp-h
...
am__DIST_COMMON = $(srcdir)/Makefile.in $(srcdir)/cuckoo-hash.spec.in \
	$(srcdir)/stamp-h.in $(top_srcdir)/Makefile.common \
...
$(am__aclocal_m4_deps):
cuckoo-hash.spec: $(top_builddir)/config.status $(srcdir)/cuckoo-hash.spec.in
...
$(top_srcdir)/version.m4: .force
	cd $(top_srcdir) && $(SHELL) ./version.sh
